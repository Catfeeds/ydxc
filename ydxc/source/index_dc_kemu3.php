      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab_01">
        <tbody>
          <tr>
            ...
            <td class="caption"><div align="center">选择教练</div></td>
            ...
            <td class="caption"><div align="center">选择教练时间</div></td>
          </tr>
<?php
	$perpage = 15;
	$page = $_REQUEST['page'];
...
//	$page<1 && $page = 1;
	...
	if($start_date_unx && $end_date_unx){
		$where .= " AND k3_time>='$start_date_unx' AND k3_time<='$end_date_unx'";
	}
