...
function getwxpz() {
		...
		success: function(data){
			...
			if (1 == data.code) {
				...
				var title = "参与最美形象代言人选拔，赢1万奖金50万创业资金。";
				var link = "http://ydxc.yooyor.com/client/";
				var imgUrl = "http://ydxc.yooyor.com/client/public/static/share.png";
				var desc = "国内首家智能化学车平台盛大起航。";
				var type = "";
				var dataUrl = "";
            		wx.ready(function(){
...
function getydxc() {
		$.ajax({
		type: 'GET',
		url: '/s_user/tp.php?method=getydxc',
		dataType: 'json',
		success: function(data){
			//alert(data);
			if (1 == data.code) {
				...
				var title = "易点学车服务平台";
				var link = "http://yixctrue.yidianxueche.cn/client/";
				var imgUrl = "http://ydxctrue.yidianxueche.cn/client/public/static/share.png";
