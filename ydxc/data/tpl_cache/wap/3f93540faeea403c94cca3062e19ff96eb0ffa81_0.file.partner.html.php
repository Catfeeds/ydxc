<?php
/* Smarty version 3.1.30, created on 2017-09-03 13:50:58
  from "/data/www/ydxc/ydxc/template/wap/partner.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59ab9842846fb8_56083356',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3f93540faeea403c94cca3062e19ff96eb0ffa81' => 
    array (
      0 => '/data/www/ydxc/template/wap/partner.html',
      1 => 1504417852,
      2 => 'file',
    ),
  ),
...
function content_59ab9842846fb8_56083356 (Smarty_Internal_Template $_smarty_tpl) {
...
';
				...
				if(phone=='' || phone==null) {
					...
					return false;
		    			...
		    			$.ajax({
		    				type:"post",
		    				url:"/ydxc/index.php?do=partner&action=post",
		    				async:true,
		    				...
		    				success:function(data) {
		    					alert(data.code);
		    					if(data.status==1) {
		    						window.location.href = "/ydxc/index.php";
		    					}
		    				}
		    			});
		    		}
    		...
    		function visit_code() {
				...
				$.ajax({
					type:"post",
					url:"/ydxc/index.php?do=partner&action=visit",
					async:true,
					data:{phone:phone,code:code},
					dataType:"json",
					success:function(data) {
						if(data.status==1) {
							window.location.href = "/ydxc/index.php?do=partner&id=9";
						}else{
							alert(data.code);
						}
					}
...
　　  //向后台发送处理数据
     ...
     　　url: "/ydxc/index.php?do=partner&action=send&phone="+phone, //目标地址
