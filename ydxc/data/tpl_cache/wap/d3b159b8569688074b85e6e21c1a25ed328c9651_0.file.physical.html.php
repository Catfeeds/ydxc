<?php
/* Smarty version 3.1.30, created on 2017-09-05 15:42:47
  from "/data/www/ydxc/ydxc/template/wap/physical.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59ae55771b0d46_89533551',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd3b159b8569688074b85e6e21c1a25ed328c9651' => 
    array (
      0 => '/data/www/ydxc/ydxc/template/wap/physical.html',
      1 => 1504597336,
      2 => 'file',
    ),
  ),
...
function content_59ae55771b0d46_89533551 (Smarty_Internal_Template $_smarty_tpl) {
?>
	<div class="container   " style="background-color: #FFFFFF;">
		
		<div class="row">
				<div class="col-xs-12">
					<a class="map-dh" <?php if (!empty($_smarty_tpl->tpl_vars['cd_info']->value['id'])) {?> href="/ydxc/index.php?do=go&id=<?php echo $_smarty_tpl->tpl_vars['cd_info']->value['id'];?>
"<?php }?>>
...
==0){
				...
				$.ajax({
					type:"POST",
					url:"/ydxc/index.php?do=pay&tj=1&money=20",
					...
					success: function (data) {
						if (1 == data.code) {
								...
								var dataUrl = "";
									...
									wx.chooseWXPay({
										       ...
										       success: function (res){
												 	//alert(res.msg);
												 	window.location.href = "/ydxc/index.php?do=physical_pay_success";
										       },
										        cencel:function(res){　　　　　　　　　　　　　　// 支付取消回调函数
												 	window.location.href = "/ydxc/index.php?do=physical_pay_fail";
										        },
								...
								window.location.href="/ydxc/index.php?do=getwxinfo";
							}
					}
				});
			}
	...
	function visit_code() {
				...
				$.ajax({
					type:"post",
					url:"/ydxc/index.php?do=physical&action=visit",
					async:true,
					data:{phone:phone,code:code},
					dataType:"json",
					success:function(data) {
						if(data.status==1) {
							window.location.href = "/ydxc/index.php?do=xlc_map&tj=1";
						}else{
							alert(data.code);
						}
					}
...
　　  //向后台发送处理数据
     ...
     　　url: "/ydxc/index.php?do=physical&action=send&phone="+phone, //目标地址
