<?php
/* Smarty version 3.1.30, created on 2017-09-29 09:59:26
  from "/data/www/ydxc/ydxc/template/wap/index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59cda8fe9a6d69_15901630',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cb3ecdad609a37a7d6157ac0c3b18afc15f32c4c' => 
    array (
      0 => '/data/www/ydxc/ydxc/template/wap/index.html',
      1 => 1506650362,
      2 => 'file',
    ),
  ),
...
function content_59cda8fe9a6d69_15901630 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row nav-bar">
                    ...
                    <a href="/index.php?do=new_detail&id=4"><img src="/ydxc/template/wap/public/css/self/icon/vrxc.png" /><i>VR学车</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=coach_list" <?php if ($_smarty_tpl->tpl_vars['user_info']->value['k2_status'] == 2 && $_smarty_tpl->tpl_vars['comment_num']->value == 0) {?>onclick="cancel_turn();return false"<?php }?>><img src="/ydxc/template/wap/public/css/self/icon/qbjl.png" /><i>全部教练</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=new_detail&id=3"><img src="/ydxc/template/wap/public/css/self/icon/fwys.png" /><i>优势服务</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=xlc_map" <?php if ($_smarty_tpl->tpl_vars['user_info']->value['k2_status'] == 2 && $_smarty_tpl->tpl_vars['comment_num']->value == 0) {?>onclick="cancel_turn();return false"<?php }?>><img src="/ydxc/template/wap/public/css/self/icon/qbcd.png" /><i>全部场地</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=partner&id=9"><img src="/ydxc/template/wap/public/css/self/icon/hhrsq.png" /><i>合伙人申请</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=new_detail&id=5"><img src="/ydxc/template/wap/public/css/self/icon/sqtj.png" /><i>学车流程</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=new_detail&id=6"><img src="/ydxc/template/wap/public/css/self/icon/xcbz.png" /><i>学车保障</i></a>
                </div>
                <div class="col-xs-3 nav-bar-item">
                    <a href="/index.php?do=xlc_map&tj=1" <?php if ($_smarty_tpl->tpl_vars['user_info']->value['k2_status'] == 2 && $_smarty_tpl->tpl_vars['comment_num']->value == 0) {?>onclick="cancel_turn();return false"<?php }?>><img src="/ydxc/template/wap/public/css/self/icon/bmtj.png" /><i>报名体检</i></a>
                </div>
            </div>
...
-->
            ...
            <div class="row activity">
                <div class="p-hd" style="background-color: #0C0A0B;margin-right: 0px;margin-left: 0px;">
                    ...
                    <p style="color: #FFFFFF; margin-left: 15px;margin-right: 15px;">易点学车是一家高度融合互联网+实体驾校的创新型互联网品牌</p>
                </div>
                <?php
				...
				wx.ready(function(){
					wx.getLocation({
					    ...
					    success: function (res) {
					        ...
					        $.ajax({
								url: '/ydxc/index.php?do=good_coach_ajax',
								type: 'get',
								dataType: 'json',
								...
								success: function(coach) {
			                        ...
			                        str += '<?php echo '<script'; ?>
 src="/ydxc/template/wap/public/js/libs/swiper-3.4.1.jquery.min.js" type="text/javascript" charset="utf-8"><\/script>';
									$("#good_coach").html(str);
					        			swiper();
								}
							});
