<?php
/* Smarty version 3.1.30, created on 2017-09-03 13:57:46
  from "/data/www/ydxc/ydxc/template/wap/my_ewm.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59ab99da765401_51973106',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '38536adba55c1d0a92d040bc915f4c2de4904aa7' => 
    array (
      0 => '/data/www/ydxc/ydxc/template/wap/my_ewm.html',
      1 => 1504418208,
      2 => 'file',
    ),
  ),
...
function content_59ab99da765401_51973106 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
        ...
        <?php echo '<script'; ?>
 src="/ydxc/template/wap/public/js/libs/jquery-2.2.3.min.js" type="text/javascript" charset="utf-8"><?php echo '</script'; ?>
>
        <!--<?php echo '<script'; ?>
...
>
        <?php echo '<script'; ?>
 src="/ydxc/template/wap/public/js/self/custom.js" type="text/javascript" charset="utf-8"><?php echo '</script'; ?>
>
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/public/css/self/reset.css" />
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/css/iconfont.css"/>
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/public/css/libs/swiper-3.4.1.min.css" />
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/public/css/self/custom.css" />
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/css/style.css" />
        <link rel="stylesheet" type="text/css" href="/ydxc/template/wap/css/frozen.css" />
    </head>
...
';
			...
			function visit_code() {
				...
				$.ajax({
					type:"post",
					url:"/ydxc/index.php?do=myewm&action=visit",
					async:true,
					...
					success:function(data) {
						if(data.status==1) {
							alert("绑定成功");
							window.location.href="/ydxc/index.php?do=myewm";
						}else{
							alert(data.code);
						}
					}
			...
			　　  //向后台发送处理数据
			     ...
			     　　url: "/ydxc/index.php?do=myewm&action=send&phone="+phone, //目标地址
