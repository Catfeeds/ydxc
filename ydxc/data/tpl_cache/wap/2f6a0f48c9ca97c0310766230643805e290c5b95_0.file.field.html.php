<?php
/* Smarty version 3.1.30, created on 2017-09-29 10:21:31
  from "/data/www/ydxc/ydxc/template/wap/field.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59cdae2bd5f033_43548600',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2f6a0f48c9ca97c0310766230643805e290c5b95' => 
    array (
      0 => '/data/www/ydxc/template/wap/field.html',
      1 => 1506651682,
      2 => 'file',
    ),
  ),
...
function content_59cdae2bd5f033_43548600 (Smarty_Internal_Template $_smarty_tpl) {
...
,<?php echo $_smarty_tpl->tpl_vars['item']->value['lat'];?>
 ...
 = new BMap.Icon("/ydxc/template/wap/img/drive.png", new BMap.Size(20,20));
						<?php } else { ?>
						var myIcon<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
 = new BMap.Icon("/ydxc/template/wap/img/hospital.png", new BMap.Size(20,20));
						<?php }?>
...
(){
							<?php if ($_smarty_tpl->tpl_vars['item']->value['class_id'] == 5) {?>
							$.ajax({
								url:'/ydxc/index.php?do=xlc_map_ajax&id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
...
";
							$.ajax({
								url:'/ydxc/index.php?do=physical&id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
&k=<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
&tj=<?php echo $_smarty_tpl->tpl_vars['tj']->value;?>
',
								type:'get',
...
?>
					    ...
					    translateCallback = function (data){
					      if(data.status === 0) {
							...
							var myIc = new BMap.Icon("/ydxc/template/wap/img/dw.png", new BMap.Size(30,30));
