<?php
/* Smarty version 3.1.30, created on 2017-09-18 23:13:00
  from "/data/www/ydxc/ydxc/template/wap/enlist_order.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59bfe27cb8ef53_94555977',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f8faae5428e23d4462c8d76bbf11825e983b2126' => 
    array (
      0 => '/data/www/ydxc/ydxc/template/wap/enlist_order.html',
      1 => 1505747563,
      2 => 'file',
    ),
  ),
...
function content_59bfe27cb8ef53_94555977 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<div class="row protocol">
				<div class="col-xs-12">
					<label>
						...
						本人已阅读并签署易点学车<a href="/ydxc/index.php?do=pxxy">《培训协议》</a>（电子协议与纸质协议具有同等法律效益)
					</label>					
				</div>
			</div>
...
';
	...
	　　  //向后台发送处理数据
	     ...
	     　　url: "/ydxc/index.php?do=k2_msg&action=send&phone="+phone1, //目标地址
...
;
		...
		if(""==name||""==phone||""==card_id){
			...
			$.ajax({
				type:"POST",
				url:"/ydxc/index.php?do=pay&class="+class_id+"&money="+money,
							...
							var dataUrl = "";
								...
								wx.chooseWXPay({
									       ...
									       success: function (res){
											 	//alert(res.msg);
											 	//sendMessage();
											 	window.location.href = "/ydxc/index.php?do=enlist_pay_success&phone=<?php echo $_smarty_tpl->tpl_vars['coach_info']->value['coach_phone'];?>
";
									       },
									        cencel:function(res){　　　　　　　　　　　　　　// 支付取消回调函数
											 	window.location.href = "/ydxc/index.php?do=enlist_pay_fail";
									        },
