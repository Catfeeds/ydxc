<?php /* Smarty version 2.6.22, created on 2016-11-28 04:50:26
         compiled from show.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'nl2br', 'show.html', 11, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
unset($_smarty_tpl_vars);
 ?>
				...
				<!--教练风采加一个返回按钮-->
				<?php if ($this->_tpl_vars['class_id'] == 3): ?>
					<div>
						<a href="index.php?do=intro&class_id=<?php echo $this->_tpl_vars['class_id']; ?>
