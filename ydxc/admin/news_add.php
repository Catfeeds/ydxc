  ...
  <form  method="post" enctype="multipart/form-data" name="FormEdit" onSubmit="return Validator.Validate(this,3)">
    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab_01">
      <tbody>
        ...
        <tr class="jiaolian2">
          <td class="caption"> 管理员姓名</td>
          <td><input name="manager_name" type="text" id="manager_name" value="<?php echo @$manager_name; ?>" size="20" maxlength="20" ></td>
        </tr>
        <tr class="jiaolian2">
          <td class="caption"> 管理员电话</td>
          <td><input name="manager_phone" type="text" id="manager_phone" value="<?php echo @$manager_phone; ?>" size="20" maxlength="20" ></td>
        </tr>
        <tr>
        ...
        <tr class="jiaolian2">
          ...
          <td><input name="xingming" type="text" id="xingming" value="<?php echo @$xingming; ?>" size="20" maxlength="20" ></td>
        </tr>
        
        <tr class="jiaolian2">
          <td class="caption"> 教练电话</td>
          <td><input name="coach_phone" type="text" id="coach_phone" value="<?php echo @$coach_phone; ?>" size="20" maxlength="20" ></td>
        </tr>
        
        <tr>
          <td class="caption"> 优质教练</td>
          <td><input name="good_coach" type="checkbox" id="good_coach" value="1" <?php echo @$good_coach ? 'checked' : ''; ?>></td>
        </tr>
        
        <tr class="jiaolian2">
          <td class="caption"> 累计培训人数</td>
          <td><input name="ljpxrs" type="text" id="ljpxrs" value="<?php echo @$ljpxrs; ?>" size="10" maxlength="10" ></td>
        </tr>
        
        <tr class="jiaolian2">
          <td class="caption"> 科二通过率</td>
          <td><input name="ketgl" type="text" id="ketgl" value="<?php echo @$ketgl; ?>" size="10" maxlength="10" ><label>%</label></td>
        </tr>
        
        <tr class="jiaolian2">
          <td class="caption"> 科三通过率</td>
          <td><input name="kstgl" type="text" id="kstgl" value="<?php echo @$kstgl; ?>" size="10" maxlength="10" ><label>%</label></td>
        </tr>
        
        <tr class="jiaolian2">
          <td class="caption"> 教练所属场地</td>
        ...
        <tr>
          <td class="caption">场地详细地址</td>
          <td><input name="cd_address" type="text" id="cd_address" value="<?php echo @$cd_address; ?>" size="60" maxlength="255"></td>
        </tr>
        <tr>
        <!--<tr class="jiaolian2">
