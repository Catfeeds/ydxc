      ...
      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab_01">
        <tbody>
          <tr>
            ...
            <td width="15%" class="caption">品牌</td>
            <td width="35%"> <?php 
		...
		<tr>
          ...
          <td><input name="warnnum" type="text" id="warnnum" value="<?php echo isset($warnnum) ? $warnnum : '' ; ?>" size="20" maxlength="255" datatype="Integer" msg="请填写物资预警数量."></td>
