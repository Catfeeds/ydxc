    ...
    <form  method="post" name="FormEdit" onSubmit="return Validator.Validate(this,3)">
      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab_01">
        ...
        <tr>
          ...
          <td><input name="createname" type="text" id="createname" value="<?php echo isset($createname) ? $createname : '' ; ?>" size="50" maxlength="255" disabled /></td>
        </tr>
        <tr>
          <td class="caption">所属仓库</td>
          <td><input name="departmentid" type="text" id="departmentid" value="<?php echo isset($storename) ? $storename : ''; ?>" size="50" maxlength="255" disabled /></td>
        </tr>
