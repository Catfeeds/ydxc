...
/*
	...
	$Id: weixin_image_add.php 2013-11-24 22:29:55 jerry $
*/

!defined('IN_CTB') && die('Access Denied');

checkpermission('', 'image'); //权限检查
...
if (isset($_POST['usage'])) {
	...
	if ($id <= 0) { //添加
		...
		showmsg('内容添加成功！', 'module.php?ac=weixin&mod=image');
		...
		showmsg('内容修改成功！', 'module.php?ac=weixin&mod=image');
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input name="button" type="submit" class="button" id="button" value="提交">
            <input name="id" type="hidden" id="id" value="<?php echo isset($id) ? $id : 0; ?>">
