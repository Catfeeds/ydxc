...
//2009-03-03 添加，初始化时间的值   
  ch[obj_name == "date_start" ? 0 : 23 ].selected =true; //this.hour
  cM[obj_name == "date_start" ? 0 : 59 ].selected =true;   //this.minute
  cs[obj_name == "date_start" ? 0 : 59 ].selected =true;   //this.second
}   
...
Calendar.prototype.show = function (dateObj, popControl) {   
  ...
  this.month = this.date.getMonth();   
  this.day = this.date.getDate();   
  this.hour = obj_name == "date_start" ? 0 : 23; //this.date.getHours();   
  this.minute = obj_name == "date_start" ? 0 : 59; // this.date.getMinutes();   
  this.second = obj_name == "date_start" ? 0 : 59; //this.date.getSeconds();   
  this.changeSelect();   
  this.bindData();   
