...
?>
  ...
  <DIV class=datacontainer2 style="WIDTH: 98%">
	...
	&nbsp;
	<?php echo @makeselect($_TGLOBAL['tree_partner_class'],'class_id', $class_id,'datatype="Require" msg="请选择栏目"','name', 'id','请选择栏目', '0', 1);?>
...
echo makeselect((array)$_TGLOBAL['tree_partner_class'],'class_id', $class_id,'datatype="Require" msg="请选择栏目"','name', 'id','请选择栏目', '0', 1);?>
