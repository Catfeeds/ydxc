...
class DB_Sql_vb {
  ...
  function halt($msg) {
    ...
    if ($this->reporterror==1) {
      ...
      echo "</table></td></tr></table></form>\n<blockquote><p>&nbsp;</p><p><b>$GLOBALS[bbtitle] ��ݿ��������һЩ΢С�Ĵ���.</b><br>\n";
      echo "�밴������� <a href=\"javascript:window.location=window.location;\">ˢ��</a> ��ť����.</p>";
      echo "һ��E-Mail�Ѿ����͵����ǵ� <a href=\"mailto:$technicalemail\">����֧������</a>, ���������Ȼ����, ��Ҳ���Է��ʼ���ϵ.</p>";
      echo "<p>����Ϊ�ɴ˸������������б�Ǹ.</p>";
